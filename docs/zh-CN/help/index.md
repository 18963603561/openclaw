---
read_when:
    - 你是新用户，并且想要“我该点击/运行什么”的指南
    - 某些内容出了问题，而你想要最快的修复路径
summary: 帮助中心：常见修复、安装完整性检查，以及出现故障时应查看的位置
title: 帮助
x-i18n:
    generated_at: "2026-04-08T05:54:59Z"
    model: gpt-5.4
    provider: openai
...
- **Gateway 网关问题：** [故障排除](/zh-CN/gateway/troubleshooting)
- **日志：** [日志记录](/zh-CN/logging) 和 [Gateway 网关日志](/zh-CN/gateway/logging)
- **修复：** [Doctor](/zh-CN/gateway/doctor)

如果你想查找概念性问题（而不是“某些内容出了问题”）：

- [常见问题（概念）](/zh-CN/help/faq)

## 环境和调试

- **环境变量：** [环境变量](/zh-CN/help/environment)
- **调试：** [调试](/zh-CN/help/debugging)
- **测试：** [测试](/zh-CN/help/testing)
