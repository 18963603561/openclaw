...
常见问题：[常见问题](/zh-CN/help/faq#why-are-there-two-exec-approval-configs-for-chat-approvals)
...
- [沙箱隔离 vs 工具策略 vs Elevated](/zh-CN/gateway/sandbox-vs-tool-policy-vs-elevated) — 何时使用各自方案
