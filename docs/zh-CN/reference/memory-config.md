...
- [QMD 引擎](/zh-CN/concepts/memory-qmd) -- local-first sidecar
- [Memory 搜索](/zh-CN/concepts/memory-search) -- 搜索管线和调优
...
[`session.sendPolicy`](/gateway/configuration-reference#session) 相同：
