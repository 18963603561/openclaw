...
read_when:
    - 你想查看完整的文档地图
summary: 链接到每一页 OpenClaw 文档的 hubs
title: Docs Hubs
x-i18n:
    generated_at: "2026-04-08T07:11:29Z"
    model: gpt-5.4
    provider: openai
...
使用这些 hubs 来发现每一页文档，包括那些不会出现在左侧导航中的深入解析和参考文档。
...
- [聊天渠道 hub](/zh-CN/channels)
- [模型提供商 hub](/zh-CN/providers/models)
...
- [远程网关 README](/zh-CN/gateway/remote-gateway-readme)
...
- [macOS 远程控制](/zh-CN/platforms/mac/remote)
...
- [插件 bundles](/zh-CN/plugins/bundles)
